...
const CustomerForgotPassword = ({ onBackToLogin }: CustomerForgotPasswordProps) => {
    ...
    const handleSendOtp = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`${API_BASE}/customer/forgot-password/send-otp`, {
                method: 'POST',
                headers: {
    ...
    const handleResetPassword = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`${API_BASE}/customer/forgot-password/reset`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    required
                                    maxLength={6}
                                    className="pl-10 text-center text-2xl tracking-widest border-purple-200 focus:border-purple-500"
                                />
                            </div>
                        </div>
