...
interface DataOperatorForgotPasswordProps {
    onBackToLogin: () => void;
}
...
const DataOperatorForgotPassword = ({ onBackToLogin }: DataOperatorForgotPasswordProps) => {
    ...
    const handleSendOtp = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`${API_BASE}/data-operator/forgot-password/send-otp`, {
                method: 'POST',
                headers: {
    ...
    const handleResetPassword = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`${API_BASE}/data-operator/forgot-password/reset`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
...
export default DataOperatorForgotPassword;
